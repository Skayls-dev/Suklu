"""
Suklu AI Gateway — Cloud Run FastAPI service.

Architecture decisions:
- All LLM calls are abstracted behind LLMClient so providers are swappable.
- Firebase ID tokens are verified on every request (middleware).
- Every AI response is logged to Firestore via logging_service.
- Content safety middleware runs BEFORE the route handlers.
"""
